<template>
  <div class="pagebox">
    ...
    <div class="pagebox-content">
      ...
      <el-table :data="tableData" border v-loading="!ableToLoad" size="mini"
        stripe>
...
<script>
import addUpdate from "src/components/CommentCom/addUpdate";
...
export default {
  ...
  methods: {
    ...
    isDel(status, item) {
      let that = this;
      let url = `${that.API}/api/comment/hidden/${item.id}`;
      let params = {
        status
      };
    ...
    getList() {
      ...
      let url = `${this.API}/api/comment/list`;
      let params = {
        ...this.searchData,
    ...
    delHandler(item) {
      let url = `${this.API}/api/comment/delete/${item.id}`;
      let params = {
        id: item.id
      };
